...
/* "role": "event" у локации (markers.json) — старые/декоративные точки,
   ...
   другой формы: почти ровный квадрат вместо круга (20.09.2026, по просьбе
   игрока — до этого был ромб, см. NODE_STYLE и makeIconShape в js/map.js),
   чтобы на глаз сразу читались как другая категория.
   ⚠️ Размер чуть БОЛЬШЕ базовых 8: у квадрата в раскладке считается тот же
   скалярный «размер», что у круга, но видимой площади при равном размере у
   него больше — 9 подобрано так, чтобы на карте он читался крупнее круглой
   локации, но не налезал на соседей. */
const EVENT_LOCATION_SIZE = 9;
